...
public abstract class BaseSupplierOrder<M extends BaseSupplierOrder<M>> extends Model<M> implements IBean {
	...
	public void setAuthenticateTime(java.util.Date authenticateTime) {
		set("authenticate_time", authenticateTime);
	}
	
	public java.util.Date getAuthenticateTime() {
		return get("authenticate_time");
	}
